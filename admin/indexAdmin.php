<?php
include "../function.php"; // Mundur satu folder
...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/styles.css"> <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/css/bootstrap.min.css" crossorigin="anonymous"/>
    <link href="https://fonts.googleapis.com/css?family=Poppins:300,400,700&display=swap" rel="stylesheet"/>
</head>
<body >
    <div class="kiri">
        <section class="logo">
            <img src="../assets/img/logobaru.jpg" alt="logobaru" height="70px" /> </section>
        ...
        <section class="isi">
            <a class="nav-link" href="indexPakar.php"><span>Data Riwayat</span></a>
        </section>
        <div class="sidebar-heading">
            <h5 class="font-weight-bold text-white text-uppercase teks">Gejala & Status</h5> 
        </div>
        <section class="isi">
            <a class="nav-link" href="indexPenyakit.php"><span>Data Status</span></a>
        </section>
        <section class="isi">
        ...
        <section class="isi">
            <a class="nav-link" href="../logout.php"><span>Logout</span></a> </section>
    </div>
