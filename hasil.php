...
// Periksa jika variabel sesi untuk persentase risiko ada
$dmsatu = $_SESSION['dmsatu'] ?? 0;
$dmdua = $_SESSION['dmdua'] ?? 0;
$gesta = $_SESSION['gesta'] ?? 0;
$neo = $_SESSION['neo'] ?? 0;

// Fungsi untuk menentukan risiko
        ...
        <div class="container">
            <div class="row">
                <div class="col align-self-center">
                    ...
                    <h5 class="mb-4">
                        <div class="py-1"><strong><?= $riskDmsatu; ?></strong></div>
                    </h5>
                ...
                <div class="col d-none d-sm-block"><img width="500" src="hasil.jpg" alt="hero" /></div>
            </div>
        </div>
    </section>
</body>
