<?php
$koneksi = mysqli_connect('localhost', 'root', '', 'cek', 3307);
...
function registerPakar()
{
    ...
    if (!$exe) {
        ...
        document.location.href = 'admin/indexPakar.php';
            </script>";
    }
}
    ...
    if($data) {
        ...
        if(password_verify($input_pass, $password)) {
            ...
            if($role =="1") {
                ...
                $_SESSION['role'] = 0;
                echo "<script>document.location.href = 'admin/indexAdmin.php';</script>";
            } elseif($role =="2") {
                $_SESSION['role'] = 2;
                echo "<script>document.location.href = 'admin/indexPakar.php';</script>";
            }
        } else {
            echo "<script>
...
function tambahGejala()
{
    ...
    if (!$exe) { die('Error pada database'); }   
    ...
    if(!$ex){ die('Error pada database'); }
    echo "<script>
    alert('Gejala berhasil ditambahkan');
    document.location.href = 'admin/indexGejala.php'</script>";
}
...
function tambahPenyakit()
{
    ...
    document.location.href = 'admin/indexPenyakit.php'</script>";
}
...
function tambahSolusi()
{
    ...
    document.location.href = 'admin/indexSolusi.php'</script>";
}
...
function ubahPasien($id_user)
{
    ...
    document.location.href = 'admin/indexAdmin.php'</script>";
}
...
function ubahPakar($id_user)
{
    ...
    document.location.href = 'admin/indexPakar.php'</script>";
}
...
function hapusGejala($id_gejala)
{
    ...
    if ($result > 0) {
        echo "<script>
                ...
                document.location.href = 'admin/indexGejala.php';
            </script>";
    } else {
        echo "<script>
...
function hapusPenyakit($id_penyakit)
{
    ...
    if ($result > 0) {
        echo "<script>
                ...
                document.location.href = 'admin/indexPenyakit.php';
            </script>";
    } else {
        echo "<script>
...
function hapusSolusi($id_solusi)
{
    ...
    if ($result > 0) {
        echo "<script>
                ...
                document.location.href = 'admin/indexSolusi.php';
            </script>";
    } else {
        echo "<script>
